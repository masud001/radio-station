...
export class App extends Component<{}, StationState> {
	...
	render() {
		return (
			<React.Fragment>
				<section id='app' className={AppStyle.radio__station_wrapper}>
					{/* header START  */}
					...
					<div className={AppStyle.radio_stations}>
						<ul id='station_lists' className={AppStyle.radio_stations_list}>
							{this.state.stations &&
					...
					<div id='footer_wrapper' className={AppStyle.footer__wrapper}>
